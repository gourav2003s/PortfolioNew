    ...
    <section id="contact" className="py-20">
      <div className="max-w-xl mx-auto text-center">
        <h2 className="text-3xl font-bold mb-8 flex items-center justify-center">
          <span className="text-secondary mr-2">04.</span>
          Get In Touch
        </h2>
        ...
        <div className="space-y-4">
          <a
            href="mailto:gouravsinghs2003@gmail.com"
          ...
          <div className="flex justify-center space-x-6 mt-8">
            <a
              href="https://github.com/gourav2003s"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/in/gaurav-singh-96382923a/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-textPrimary hover:text-secondary transition-colors"
            >
